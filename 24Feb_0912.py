...
def depth_map(data_dir):
    depth_dir = os.path.join(data_dir, 'Depth2/')
    ...
    ###########################################3
    # Check
    # with h5py.File(data_dir+'parameters(copy).h5','r') as pf:
    #     srcs = pf['src'].value
    #     bird_hights = pf['bird_hight'].value
    #     bird_widths = pf['bird_width'].value
    #     bird_channelss = pf['bird_channels'].value
    ...
    for i in range(len(boxes_list)):
        ...
        distance = pow(2,(eRAT/RCA)) * cp / pow(12,eRCT)                 # 3
    ...
    for z in range(200):
        ...
        # Info
        # Kalo negatif = kependekan
        # Kalo positif = kepanjangan
...
if __name__ == '__main__':
    data_dir = "/media/ferdyan/LocalDiskE/Hasil/dataset/Final/41/"
